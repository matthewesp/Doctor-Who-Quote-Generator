...
tweeter(){
    ...
    render() {
        return (
          <div>
            <h1 className="title center-text">Doctor Who Quote Generator</h1>
            {this.state.quote ? (
              <QuoteBox
              ...
              <div className="box-sizing">
                <p className="v-align">
                  Click Below to get a Quote from Doctor Who
                </p>
              </div>
            )}
